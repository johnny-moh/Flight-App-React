        ...
        return (
            ...
            <div className="container ">
                ...
                <div className="row gx-4">
                    ...
                    <h1 className="font-weight-light">Home Page of FlightApp</h1>
                                    ...
                                    <tr key={color.id}>
                                        ...
                                        <td>
                                            ...
                                            <Link type="button"
                                                ...
                                                to={"/editColor/" + color.id}>Edit</Link>

                                            <button onClick={() => { this.props.deleteColor(color.id) }}
                ...
                <div className="row gx-4 gx-lg-5 text center">
                    <div className="col-md-4 mb-5 text center">
                        ...
                        <h2 className="text center">See The Flight Lists </h2>
                        <p className="text center">Chech our massive flight database to find yor best one!</p>
                    </div>
